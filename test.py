...
if response == "":
    print("\nLumayas ka! Hindi ka naman pala bibili.")

elif response == "chip" or response == "chips":
    ...
    elif response != "piattos" or response != "nova" or response != "cheezy":
    ...
    elif response != "coke" or response != "royal" or response != "mountaindew":
    ...
    elif response != "monsterwhite" or response != "monstermango" or response != "sting":
        print("\nTatlong klase lang binebenta namin! Kaya pumili ka lang sa tatlo; kung 'MonsterWhite', 'MonsterMango', o 'Sting'")
    
elif response != "chip" or response != "chips" or response != "softdrink" or response != "softdrinks" or response != "energydrink" or response != "energydrinks":
